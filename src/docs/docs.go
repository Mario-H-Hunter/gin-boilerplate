    ...
    "paths": {
        "/storage/sync": {
            "post": {
                ...
                "summary": "Syncs Two versions of Object Storage, the local and the cloud version. It uses fully qualified names as keys, md5 hashes to determine divergence",
        ...
        "/uploads/initiate": {
            "post": {
                ...
                "summary": "Initiates a new file upload using file metadata and returns self-signed url",
